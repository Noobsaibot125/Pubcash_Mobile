...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Future<void> _loadHistory() async {
    ...
    try {
      ...
      final List<dynamic> filteredVideos = interactions.where((item) {
        ...
        DateTime? dateInteraction = DateTime.tryParse(
          item['date_interaction'].toString(),
        );
      ...
      filteredVideos.sort((a, b) {
        DateTime dateA =
            DateTime.tryParse(a['date_interaction'].toString()) ??
            DateTime(2000);
        DateTime dateB =
            DateTime.tryParse(b['date_interaction'].toString()) ??
            DateTime(2000);
  ...
  void _playVideo(Map<String, dynamic> videoData) {
    ...
    if (videoData['url_video'] != null &&
        videoData['url_video'].toString().isNotEmpty) {
    Navigator.push(
        context,
        MaterialPageRoute(
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            "Cette vid̩o a expir̩ car elle date de plus de 7 jours. Seul l'aper̤u est conserv̩.",
          ),
          actions: [
            TextButton(
