...
import 'profile/terms_screen.dart'; // N'oublie pas de créer celui-ci si tu veux la page vide
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildDivider() {
    return const Divider(height: 1, indent: 60, endIndent: 20, color: Colors.black12);
  }
}
...
class _ProfileMenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      trailing: hideChevron ? null : const Icon(Icons.arrow_forward_ios, size: 16, color: Colors.grey),
    );
  }
}