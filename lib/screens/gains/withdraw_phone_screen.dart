...
class _WithdrawPhoneScreenState extends State<WithdrawPhoneScreen> {
  ...
  void _goToVerify() {
    if (_phoneController.text.length < 10) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Numéro invalide (10 chiffres)")));
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            const Text("Choisissez le numéro de destinataire", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                ...
                child: Row(
                  children: [
                    ...
                    const Column(
                      ...
                      children: [
                        Text("Utiliser mon numéro", style: TextStyle(fontWeight: FontWeight.bold)),
                        Text("Celui de mon profil", style: TextStyle(color: Colors.grey, fontSize: 12)),
                      ],
                    ),
                    const Spacer(),
                    Radio(
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Entrez le numéro", style: TextStyle(fontWeight: FontWeight.bold)),
                  TextField(
